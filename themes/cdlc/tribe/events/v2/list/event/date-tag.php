...
<div class="tribe-events-calendar-list__event-date-tag tribe-common-g-col">
    <time class="tribe-events-calendar-list__event-date-tag-datetime" datetime="<?php echo esc_attr( $event_date_attr ); ?>">
        <span class="sr-only"><?php echo $display_date->format_i18n( 'l, M jS, Y' ); ?></span>

        <span class="tribe-events-calendar-list__event-date-tag-weekday" aria-hidden="true">
            <?php echo esc_html( $event_week_day ); ?>
        </span>
        <span class="tribe-events-calendar-list__event-date-tag-daynum tribe-common-h5 tribe-common-h4--min-medium" aria-hidden="true">
